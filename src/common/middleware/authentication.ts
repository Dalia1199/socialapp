...
export const decoded_and_fetchuser=async(authorization:string)=>{
    if(!authorization){
...
export const authentication = async (
    ...
    const { user, decoded } = await decoded_and_fetchuser(authorization!)
   req.user=user
   req.decoded=decoded
   next()
    }
export const authentication_qrarhql = async (authorization:string) => {
